  ...
  return (
    <View className="flex-1 bg-white dark:bg-neutral-900">
      <View className="flex-row items-center pt-16 pb-5 px-5">
        ...
        <ThemedText type="title">Datenschutzerklärung</ThemedText>
      </View>

      <ScrollView className="px-5 pb-10">
        <Text className="text-3xl font-bold mb-1 text-olive_bright">Käse mit Liebe</Text>
        <Text className="text-sm mb-5 text-gray-500 dark:text-neutral-500">Letzte Aktualisierung: 13. Februar 2026</Text>

        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
        ...
        <Text className="text-lg font-bold mt-5 mb-2 text-olive_bright">1. Welche Daten wir sammeln</Text>
        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
        ...
        <Text className="text-lg font-bold mt-5 mb-2 text-olive_bright">2. Wie wir Daten verwenden</Text>
        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
        ...
        <Text className="text-lg font-bold mt-5 mb-2 text-olive_bright">3. Nutzung der Kamera und Fotos</Text>
        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
        ...
        <Text className="text-lg font-bold mt-5 mb-2 text-olive_bright">4. Profilanzeige</Text>
        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
        ...
        <Text className="text-lg font-bold mt-5 mb-2 text-olive_bright">5. Wo Daten gespeichert werden</Text>
        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
        ...
        <Text className="text-lg font-bold mt-5 mb-2 text-olive_bright">6. Weitergabe an Dritte</Text>
        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
        ...
        <Text className="text-lg font-bold mt-5 mb-2 text-olive_bright">7. Werbung und Analyse</Text>
        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
          Im Service werden keine Werbung und keine Analysen von Drittanbietern verwendet.
        </Text>

        <Text className="text-lg font-bold mt-5 mb-2 text-olive_bright">8. Online-Shop</Text>
        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
        ...
        <Text className="text-lg font-bold mt-5 mb-2 text-olive_bright">9. Löschung von Konto und Daten</Text>
        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
        ...
        <Text className="text-lg font-bold mt-5 mb-2 text-olive_bright">10. Zweck des Projekts</Text>
        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
        ...
        <Text className="text-lg font-bold mt-5 mb-2 text-olive_bright">11. Änderungen der Richtlinie</Text>
        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
          Wir können diese Datenschutzerklärung periodisch aktualisieren. Die aktuelle version ist immer auf dieser Seite verfügbar.
        </Text>

        <Text className="text-lg font-bold mt-5 mb-2 text-olive_bright">12. Kontakt</Text>
        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
        ...
        <Text className="text-lg font-bold mt-5 mb-2 text-olive_bright">13. Moderation von Nutzerinhalten (UGC)</Text>
        <Text className="text-base leading-6 text-textmain dark:text-neutral-300">
        ...
        <Text className="text-sm italic mt-8 pt-5 border-t border-neutral-200 dark:border-neutral-800 text-gray-400 dark:text-neutral-500">
